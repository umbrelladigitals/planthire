    ...
    <header className="sticky top-0 z-50 w-full bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-slate-200">
      <div className="container flex h-20 items-center justify-between">
        ...
        <nav className="hidden md:flex gap-2 items-center">
          <Link href="/products" className="font-extrabold uppercase tracking-widest text-[11px] text-slate-600 hover:text-primary transition-colors px-3 py-2">Equipment Catalog</Link>
        </nav>
          ...
          <SheetContent side="right" className="sm:max-w-sm w-full max-w-[85vw] p-0 flex flex-col border-l border-slate-200 bg-white">
            ...
            <div className="flex-1 overflow-y-auto">
              <nav className="flex flex-col py-4">
                <Link href="/" className="flex items-center px-8 h-12 font-extrabold uppercase tracking-widest text-[11px] text-slate-600 hover:text-primary hover:bg-slate-50 transition-colors">HOME</Link>
                <Link href="/products" className="flex items-center px-8 h-12 font-extrabold uppercase tracking-widest text-[11px] text-slate-600 hover:text-primary hover:bg-slate-50 transition-colors">EQUIPMENT CATALOG</Link>
              </nav>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 text-slate-700 font-bold text-xs tracking-wider">
                      ...
                      <span className="text-[10px] break-all">info@example.com</span>
                    </div>
                    <div className="flex items-center gap-4 text-slate-700 font-bold text-xs tracking-wider">
                      <div className="bg-white p-2 border border-slate-200">
